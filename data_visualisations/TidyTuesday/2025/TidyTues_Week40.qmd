...
![Chart](thumbnails/TidyTues_Week40.png){#fig-singlechart}
Table of Euroleague BasketBall Wins
...
master <- euroleague_basketball |> 
    ...
    mutate(Final_Four_Count = str_count(Years_of_FinalFour_Appearances, ",") + 1,
          Title_Won_Count = case_when(Years_of_Titles_Won %in% c("None", "0", NA_character_) ~ 0,  TRUE ~ str_count(Years_of_Titles_Won, ",") + 1),
  ...
  reactable(
    ...
    columns = list(
      ...
      Final_Four_Count = colDef(
        name = "Appearances in Final Four",
        headerStyle = list(textAlign = "center"),
